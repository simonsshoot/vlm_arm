...
我的指令:桌上有一个小人和一个耳机盒，将耳机抓起来砸到小人上；.你输出:{'function':['vlm_move("把耳机盒放到小人上")'], 'response':'拿的越高，摔的越狠，砸的越痛！'}
我的指令:桌上有一把玩具刀，将刀抓起来并挥舞.你输出：{'function':['vlm_move_gripper("抓起桌上玩具刀")','head_dance()'], 'response':'刀剑不长眼，接我一招！'}
