...
使用360视觉大模型定位物体，返回物体坐标，比如：vlm_360_locate('桌上有一个小人')
...
我的指令:先归零，再移动到小人的位置，然后摇头.你输出:{'function':['back_zero()', 'vlm_360_locate("桌上有一个小人")', 'head_shake()'], 'response':'好的，我先回到原点，然后用我的火眼金睛找到小人，最后摇个头'}
我的指令:找到桌上的玩具车，移动到那里.你输出:{'function':['vlm_360_locate("桌上的玩具车")'], 'response':'我马上用视觉大模型定位玩具车'}
