...
def move_ri_le():
    ...
    mc.send_coords([40,-295,100,0,180,90],30,0)
    time.sleep(2)
    mc.send_coords([40,-295,85,0,180,90],30,0)
    time.sleep(2)
    GPIO.output(20, 1)
    time.sleep(0.05)
    GPIO.output(21, 0)
    time.sleep(3)
    mc.send_coords([40,-150,100,0,180,90],20,0)
    time.sleep(2)
    mc.send_coords([40,-150,85,0,180,90],20,0)
    time.sleep(2)
    GPIO.output(21, 1)
    time.sleep(1.5)
    print("=====================================")
    time.sleep(2)
    mc.send_coords([40,-150,145,0,180,90],20,0)
    time.sleep(2)
    GPIO.output(20, 0)
    time.sleep(1.5)
    mc.send_coords([40,-150,80,0,180,90],20,0)
    time.sleep(2)
    GPIO.output(20, 1)
    time.sleep(0.05)
    GPIO.output(21, 0)
    time.sleep(2)
    mc.send_coords([40,-150,100,0,180,90],30,0)
    time.sleep(1)
    mc.send_coords([40,-300,128,0,180,90],30,0)
    time.sleep(1)
    mc.send_coords([40,-300,98,0,180,90],20,0)
    time.sleep(1)
    # GPIO.output(21, 1)

    time.sleep(3)
    GPIO.output(21, 1)
    mc.send_coords([-30,-240,145,0,180,90],20,0)
    time.sleep(2)
    GPIO.output(20, 0)
    time.sleep(1.5)
    mc.send_coords([-30,-240,125,0,180,90],20,0)
    time.sleep(2)
    GPIO.output(20, 1)
    time.sleep(0.05)
    GPIO.output(21, 0)
    time.sleep(3)
    mc.send_coords([50,-220,145,0,180,90],20,0)
    time.sleep(2)
    mc.send_coords([50,-220,135,0,180,90],20,0)
    GPIO.output(21, 1)
    time.sleep(2)
    ...
    # mc.send_coords([40,-150,100,0,180,90],20,0)
    # time.sleep(2)
    # mc.send_coords([40,-300,128,0,180,90],20,0)
    # time.sleep(2)
    # mc.send_coords([40,-300,98,0,180,90],20,0)
    # time.sleep(1)
    # GPIO.output(21, 1)
